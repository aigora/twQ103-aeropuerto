...
printf("\t%d \t[%d] \t%d:%d:%d \n",i+1,tabla->lista[posicionAvion].numeroVuelo,  tabla->lista[posicionAvion].reloj.horas, tabla->lista[posicionAvion].reloj.minutos, tabla->lista[posicionAvion].reloj.segundos);
    }
